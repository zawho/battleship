...
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (__WEBPACK_DEFAULT_EXPORT__)\n/* harmony export */ });\n/* harmony import */ var _ship_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./ship.js */ \"./src/ship.js\");\n/* harmony import */ var _player_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./player.js */ \"./src/player.js\");\n/* harmony import */ var _ui_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./ui.js */ \"./src/ui.js\");\n\n\n\n\nfunction placePlayerShip(board, player, ship) {\n\tconst shipName = ship.name.slice(5).toLowerCase();\n\n\tfor (let [key, value] of Object.entries(board.allShips)) {\n\t\tif (shipName === key) {\n\t\t\tif (value[1] === value[0] + 1) {\n\t\t\t\tplayer.gameboard.placeHorizontal(value[0], ship);\n\t\t\t} else if (value[1] === value[0] - 1) {\n\t\t\t\tplayer.gameboard.placeHorizontal(value[value.length - 1], ship);\n\t\t\t} else if (value[1] === value[0] + 10) {\n\t\t\t\tplayer.gameboard.placeVertical(value[0], ship);\n\t\t\t} else if (value[1] === value[0] - 10) {\n\t\t\t\tplayer.gameboard.placeVertical(value[value.length - 1], ship);\n\t\t\t}\n\t\t}\n\t}\n}\n\nfunction startGame() {\n\tconst setupDiv = document.querySelector('.setup-div');\n\tconst gameDiv = document.querySelector('.board-div');\n\tconst setupBoard = document.querySelector('.setup-board');\n\tconst startTestArr = [];\n\n\tif (setupDiv.childNodes.length > 4) {\n\t\tsetupDiv.removeChild(setupDiv.lastChild);\n\t}\n\n\tfor (let [key, value] of Object.entries(setupBoard.allShips)) {\n\t\tif (value.length > 0) {\n\t\t\tstartTestArr.push(value);\n\t\t}\n\t}\n\n\tif (startTestArr.length < 5) {\n\t\tconst setupAlertDiv = document.createElement('div');\n\t\tsetupAlertDiv.className = 'setup-alert';\n\t\tsetupAlertDiv.innerText = 'FINISH SHIP PLACEMENT';\n\t\tsetupDiv.appendChild(setupAlertDiv);\n\t\treturn;\n\t}\n\n\tsetupDiv.style.display = 'none';\n\tgameDiv.style.display = 'grid';\n\tgameDiv.style.justifyItems = 'center';\n\n\tconst humanPlayer = new _player_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('human');\n\tconst pcPlayer = new _player_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"]('computer');\n\n\tconst humanCarrier = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('humanCarrier', 5);\n\tconst humanBattleship = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('humanBattleship', 4);\n\tconst humanDestroyer = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('humanDestroyer', 3);\n\tconst humanSubmarine = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('humanSubmarine', 3);\n\tconst humanPatrol = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('humanPatrol', 2);\n\n\tconst pcCarrier = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('pcCarrier', 5);\n\tconst pcBattleship = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('pcBattleship', 4);\n\tconst pcDestroyer = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('pcDestroyer', 3);\n\tconst pcSubmarine = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('pcSubmarine', 3);\n\tconst pcPatrol = new _ship_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('pcPatrol', 2);\n\n\tplacePlayerShip(setupBoard, humanPlayer, humanPatrol);\n\tplacePlayerShip(setupBoard, humanPlayer, humanSubmarine);\n\tplacePlayerShip(setupBoard, humanPlayer, humanDestroyer);\n\tplacePlayerShip(setupBoard, humanPlayer, humanBattleship);\n\tplacePlayerShip(setupBoard, humanPlayer, humanCarrier);\n\n\t(0,_ui_js__WEBPACK_IMPORTED_MODULE_2__.placeAllCompShips)(\n\t\tpcPlayer,\n\t\tpcPatrol,\n\t\tpcSubmarine,\n\t\tpcDestroyer,\n\t\tpcBattleship,\n\t\tpcCarrier,\n\t);\n\n\tconst playerShipLocs = (0,_ui_js__WEBPACK_IMPORTED_MODULE_2__.getShipLocs)(humanPlayer.gameboard.locations);\n\tconst compShipLocs = (0,_ui_js__WEBPACK_IMPORTED_MODULE_2__.getShipLocs)(pcPlayer.gameboard.locations);\n\n\t(0,_ui_js__WEBPACK_IMPORTED_MODULE_2__.createBoardUI)('PLAYER', 'player-board', playerShipLocs);\n\t(0,_ui_js__WEBPACK_IMPORTED_MODULE_2__.createBoardUI)(\n\t\t'COMPUTER',\n\t\t'comp-board',\n\t\tcompShipLocs,\n\t\tpcPlayer.gameboard,\n\t\thumanPlayer.gameboard,\n\t);\n\n\t(0,_ui_js__WEBPACK_IMPORTED_MODULE_2__.highlightPlayerShips)('.player-board', playerShipLocs);\n}\n\n/* harmony default export */ const __WEBPACK_DEFAULT_EXPORT__ = (startGame);\n\n\n//# sourceURL=webpack://battleship/./src/start-btn.js?");
